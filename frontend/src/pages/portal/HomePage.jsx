  ...
  return (
    <div className="relative min-h-screen bg-[#fafafa] text-slate-900 antialiased selection:bg-slate-200 selection:text-slate-900">
      ...
      <section className="pt-20 pb-20 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-6">
        ...
        {/* 顶部微徽标 */}
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-zinc-100 border border-slate-300 text-zinc-800 text-xs font-medium shadow-2xs hover:bg-zinc-200/60 transition-colors">
        ...
        <div className="pt-10 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto text-left">
          <div className="shadcn-card-hover p-4 bg-white border border-slate-300 shadow-xs">
      ...
      <section className="py-20 bg-white border-y border-slate-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <div className="inline-flex items-center gap-1 text-xs font-semibold text-zinc-600 uppercase tracking-wider bg-zinc-100 px-2.5 py-1 rounded-md border border-slate-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* 1. 工商市监 */}
            <div className="shadcn-card-hover p-6 flex flex-col justify-between space-y-4 border border-slate-300 shadow-xs">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-lg bg-zinc-100 border border-slate-300 flex items-center justify-center text-slate-900 shadow-2xs">
              ...
              <ul className="pt-3 border-t border-slate-200 text-xs text-zinc-700 space-y-1.5 font-medium">
      ...
      {/* ========================================================================= */}
      <section className="py-20 bg-[#fafafa] border-b border-slate-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="shadcn-card p-6 space-y-3 bg-white border border-slate-300 shadow-xs">
              <span className="text-xs font-mono font-semibold text-slate-800 px-2.5 py-0.5 rounded-full bg-zinc-100 border border-slate-300 inline-block">场景 01</span>
            ...
            <div className="shadcn-card p-6 space-y-3 bg-white border border-slate-300 shadow-xs">
              <span className="text-xs font-mono font-semibold text-slate-800 px-2.5 py-0.5 rounded-full bg-zinc-100 border border-slate-300 inline-block">场景 02</span>
            ...
            <div className="shadcn-card p-6 space-y-3 bg-white border border-slate-300 shadow-xs">
              <span className="text-xs font-mono font-semibold text-slate-800 px-2.5 py-0.5 rounded-full bg-zinc-100 border border-slate-300 inline-block">场景 03</span>
            ...
            <div className="shadcn-card p-6 space-y-3 bg-white border border-slate-300 shadow-xs">
              <span className="text-xs font-mono font-semibold text-slate-800 px-2.5 py-0.5 rounded-full bg-zinc-100 border border-slate-300 inline-block">场景 04</span>
      ...
      <section className="py-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="shadcn-card p-6 bg-white space-y-6 border border-slate-300 shadow-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs">
            <div className="p-4 bg-zinc-50/80 rounded-lg border border-slate-300 space-y-1.5 shadow-2xs">
        ...
        {/* 注册赠送额度提示条 */}
        <div className="p-4 rounded-xl bg-zinc-50 border border-slate-300 text-xs text-slate-900 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs">
          ...
          <button
            type="button"
            onClick={() => handleTriggerExperience()}
            className="shadcn-button-primary text-xs py-2 px-4 shrink-0 shadow-xs"
          >
            立即领取 1 次赠送
          </button>
        </div>
      ...
      <section className="py-20 bg-white border-t border-slate-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="shadcn-card p-6 space-y-3 bg-[#fafafa] border border-slate-300 shadow-xs">
      ...
      >
        <div className="space-y-6 pt-1">
          <div className="text-center space-y-2">
            <div className="w-10 h-10 rounded-full bg-zinc-100 border border-slate-300 mx-auto flex items-center justify-center text-slate-900 shadow-2xs">
